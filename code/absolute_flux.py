...
class absflux():
    ...
    def convert_PMN_J2101_2802_to_lm(self,direc,fits_file):
        ra_d = (ephem.hours(PMN_J2101_2802_RA))*180./np.pi
        dec_d = (ephem.degrees(PMN_J2101_2802_DEC))*180./np.pi

        l,m = self.radec2lm(direc,fits_file,ra_d,dec_d)
        return l,m

    def convert_PMN_J2107_2526_to_lm(self,direc,fits_file):
        ra_d = (ephem.hours(PMN_J2107_2526_RA))*180./np.pi
        dec_d = (ephem.degrees(PMN_J2107_2526_DEC))*180./np.pi
...
if __name__ == "__main__":
   ...
   fits_file = "zen.2457545.61234.xx.HH.uvcU.fits" 
   ...
   ab_object.obtainTrimBox(direc,fits_file,mask,window=10,pix_deg="PIX",plot_selection=True) 
