...
%\includegraphics[width=10cm]{ska_logo.jpg}\\
%\end{minipage}
...
\textbf{TLG: MOVED TO ABSTRACT: The 21-cm emission from redshifted neutral Hydrogen is the most promising probe of the cosmic evolution of the intergalactic medium and its transition from the dark ages to cosmic reionization. The detection of the 21-cm signal has been the main driver of several radio interferometric array 
}
\end{abstract}
